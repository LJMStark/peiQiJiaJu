...
## 基线（三件套全绿才算完成；2026-07 基线：tsc 0 错误 / lint 0 告警 / 161 pass <1s。已知例外：测试的 MODULE_TYPELESS 警告是在册债、无害（→ [archaeology-live-traps] #8），勿顺手加 `"type": "module"`）
