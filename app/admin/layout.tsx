...
export default async function AdminLayout({
  ...
  return (
    <div className="flex h-screen bg-zinc-50 flex-col md:flex-row">
      <aside className="w-full md:w-64 bg-white border-r border-zinc-200 p-6 flex flex-col gap-4">
        ...
        <Link
          href="/"
          className="text-sm text-zinc-500 hover:text-zinc-900 transition-colors mt-auto"
        >
          返回前台
        </Link>
      </aside>
