...
import { Crown, CheckCircle2, AlertCircle, Loader2, Calendar, Link2 } from 'lucide-react';
import { InviteCenter } from '@/components/InviteCenter';
import { formatBeijingDate } from '@/lib/beijing-time';
import { postJson } from '@/lib/client/api';
import type { VipCenterSection } from '@/lib/dashboard-navigation';
...
export function VipCenter({ user, section, onSectionChange }: VipCenterProps): JSX.Element {
        ...
        {VIP_CENTER_SECTIONS.map((item) => {
          ...
          return (
            <button
              ...
              className={`inline-flex min-h-11 items-center gap-2 rounded-xl px-4 py-2.5 text-sm font-medium transition ${
